    ...
    <div class="topbox2">
      <div class="top">
        ...
        <div class="citybox">
          ...
          <!-- 详细地区 -->
          <div class="detailscity" v-for="(item,index) in letter" :key="index">
            <div class="letter">{{item}}</div>
            <div class="letters">
              <div v-for="(item1,index1) in letterss" :key="index1">
                <div class="letters-item" v-for="item2 in item1" :key="item2.id">{{item2.name}}</div>
              </div>
            </div>
          </div>
        </div>
