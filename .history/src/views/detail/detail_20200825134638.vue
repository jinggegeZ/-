                  ...
                  <div class="location-box-top1-3">
                    <div class="location-box-top1-3-1">
                        <div class="location-box-top1-3-1-item" v-for="(item,index) in areas" :key="index">
                            <div v-if="Array.isArray(item)">{{item.chiid[0].title}} <span class="location-box-top1-3-1-itemimgbox"><img class="location-box-top1-3-1-itemimg" src="../../../public/image/down.png" alt=""></span></div>
