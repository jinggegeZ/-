    ...
    <div class="top">
      <div class="navbox">
        ...
        <div class="navrightbox">
          ...
          <div class="navrightbox-1">
            ...
            <div class="loginbox">
                <div class="loginbox1">
                    ...
                    <div class="headimg">
                        <div class="headimg3">注册</div>
                    </div>
                    <div class="headimg">
                    <div class="headimg3">立即登录</div>
                    </div>
                </div>
            </div>
          </div>
          <!-- 下部解析部分-->
          <div class="bottombox">
            <div class="bottombox-1"> <img class="bottombox-1img" src="http://p1.meituan.net/codeman/8cce56c467a17e04f3094d1e455462a0132772.png" alt=""></div>
          </div>
        </div>
      </div>
    </div>
