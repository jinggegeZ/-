            ...
            <div class="location-box">
                ...
                <div class="location-box-top1">
                  ...
                  <div class="location-box-top1-3">
                    <div class="location-box-top1-3-1">
                        <div class="location-box-top1-3-1-item" v-for="(item,index) in menus" :key="index">
                            <div v-if="Array.isArray(item.name)">
                                <div  v-for="(item1,index1) in item.name" :key="index1">{{item1}}</div>
                            </div>
                            <div class="location-box-top1-3-1-item" v-else>{{item.name}}</div>
                        </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="location-box-top">
                <div class="location-box-top1">
                  ...
                  <div class="location-box-top1-2"><div class="location-box-top1-2-1">全部</div></div>
                  <div class="location-box-top1-3"></div>
                </div>
              </div>
            </div>
          </div>
