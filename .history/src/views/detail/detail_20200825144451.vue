                    ...
                    <div class="location-box-top1-3-1">
                      <div class="location-box-top1-3-1-item" v-for="(item,index) in menu" :key="index">
                        ...
                        <div v-if="Array.isArray(item.name)">
                          <span v-for="(item1,index1) in item.name" :key="index1" style="padding:0 30px">{{item1[0]}}</span ><span class="elsebox"><img class="elseboximg" src="../../../public/image/down.png" alt=""></span>
                        </div>
                        <div v-else>
