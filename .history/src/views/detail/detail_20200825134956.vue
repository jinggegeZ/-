            ...
            <div class="location-box">
              ...
              <div class="location-box-top">
                <div class="location-box-top1">
                  <div class="location-box-top1-1"><div class="location-box-top1-1-1">分类</div></div>
                  <div class="location-box-top1-2"><div class="location-box-top1-2-1">全部</div></div>
                  <div class="location-box-top1-3">
                    <div class="location-box-top1-3-1">
                        <div class="location-box-top1-3-1-item" v-for="(item,index) in menu" :key="index">
                            {{item.name}} <span class="location-box-top1-3-1-itemimgbox"><img class="location-box-top1-3-1-itemimg" src="../../../public/image/down.png" alt=""></span>
                        </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="location-box-top">
                <div class="location-box-top1">
                  <div class="location-box-top1-1"><div class="location-box-top1-1-1">区域</div></div>
                  <div class="location-box-top1-2"><div class="location-box-top1-2-1">全部</div></div>
                  <div class="location-box-top1-3">
                    <div class="location-box-top1-3-1">
                        <div class="location-box-top1-3-1-item" v-for="(item,index) in areas" :key="index">
                            <div v-if="Array.isArray(item.name)"><span v-for="(item1,index1)in item.name" :key="index1">{{item1.name}}</span> <span class="location-box-top1-3-1-itemimgbox"><img class="location-box-top1-3-1-itemimg" src="../../../public/image/down.png" alt=""></span></div>
                            <div v-else>{{item.name}} <span class="location-box-top1-3-1-itemimgbox"><img class="location-box-top1-3-1-itemimg" src="../../../public/image/down.png" alt=""></span></div>
                        </div>
...
export default {
  ...
  mounted() {
    ...
    this.$api
      ...
      .catch((err) => {});
    //获取城市详情
    this.$api.crumbs({city:this.city}).then(res => {
        if(res.code === 200){
