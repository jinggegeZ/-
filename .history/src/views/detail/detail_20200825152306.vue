                    ...
                    <div class="location-box-top1-3-1">
                      <div class="location-box-top1-3-1-item" v-for="(item,index) in menu" :key="index">
                        ...
                        <div v-if="Array.isArray(item.name)" class="postionbox">
                         <span >{{item.name[0]}}</span ><span class="elsebox"><img class="elseboximg" src="../../../public/image/down.png" alt=""></span>
                         
                          <div class="location-box-nonebox">
                          <div>{{item.child[0].title}}</div>
                            <div class="nonebox1" >
                                
                                <div class="nonebox2" v-for="(item2,index2) in item.child[0].child" :key="index2">{{item2}}</div>
                        ...
                        <div v-else class="postionbox">
                          ...
                          <div class="location-box-nonebox">
                          <div class="nonebox1">{{item2}}</div>
                          <div class="nonebox1" v-for="(item2,index2) in item.child[0].child" :key="index2">
                               <div>{{item.child[0].title}}</div>
