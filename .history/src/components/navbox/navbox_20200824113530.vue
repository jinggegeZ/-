            ...
            <div class="top-loginbox">
                ...
                <div class="top-loginbox2" v-else>
                    <div class="top-loginbox2-1">
                      <div class="top-loginbox2-1imgbox"><img class="top-loginbox2-1img" src="//s0.meituan.net/bs/fe-web-meituan/e3064a3/img/head-img.png" alt=""></div>
                      <div class="userbox">{{this.user}}</div>
                      <div class="changebox"><img class="changeboximg" src="../../../public/image/changeimg.png" alt=""></div>
                    </div>
