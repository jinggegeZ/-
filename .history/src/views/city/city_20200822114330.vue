    ...
    <div class="topbox2">
      <div class="top">
        ...
        <div class="citybox">
          ...
          <!-- 详细地区 -->
          <div class="detailscity" v-for="(item,index) in letterss" :key="index">
            <div class="letter">{{item[0]}}</div>
            <div class="letters">
               <div class="letters-item" v-for="item2 in item" :key="item2.id">{{item2.name}}</div>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  this.letterss = Object.values(this.cities)
    this.letterss.map((item,index) => {
  ...
  console.log(this.letterss);
    ...
    //   this.letter.push(i);
    //   this.letters = this.citys[i];
    //   this.letterss.push(this.letters)
    //   // this.letter.map((item,index) => {
    //   //   this.letterss.map((item1,index1) => {
    //   //     if(index === index1){
    //   //      item1.unshift(item)
    //   //     }
    //   //   })
